...
const App = () => {
    ...
    const checkReporter = () => {
        fetch(endPoint + '/reporter', {
            ...
            .then((res) => res.json())
            .then((data) => setIsReporter(data.isReporter));
    };
    ...
    const checkUser = () => {
        fetch(endPoint + '/user', {
            ...
            .then((res) => res.json())
            .then((data) => setIsUser(data.isUser));
    };

    const checkPublic = () => {
        fetch(endPoint + '/public', {})
            .then((res) => res.json())
            .then((data) => setIsPublic(data.isPublic));
    };
                ...
                <Router>
                    ...
                    <Switch>
                        ...
                        <Route exact path='/forum'>
                            <ForumPage isUser={isUser} />
                        </Route>
                        <Route exact path='/forum/categorized/:categorized_id'>
                            <CategorizedPost isUser={isUser} />
                        </Route>
                        <Route exact path='/forum/popular'>
                            <Popular isUser={isUser} />
                        </Route>
                        <Route exact path='/forum/post/postdetail/:id'>
                            <PostDetail />
                        </Route>
                        <Route exact path='/login'>
                            <Login />
                        </Route>
                        <Route exact path='/login/:verified'>
                            <Login />
                        </Route>
