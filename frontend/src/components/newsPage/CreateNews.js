                                    ...
                                    <form onSubmit={handleSubmit(submit)} enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3 col-7">
                                                ...
                                                <input type="text" name="title" class={`form-control border border-secondary ${errors.title ? 'is-invalid' : ''}`} placeholder="Article Title" id="posttitle" {...register('title')} />
                                                <div className="invalid-feedback">{errors.title?.message}</div>
                                            </div>
                                            <div class="form-group mb-3 col-5">
                                                <label for="inputGroupSelect01">Category</label>
                                                <div>
                                                    <select name="news_category_id" class={`custom-select  ${errors.category ? 'is-invalid' : ''}`} id="inputGroupSelect01" style={{ "height": "35px" }}  {...register('category')}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class={`form-control border border-secondary ${errors.content ? 'is-invalid' : ''}`} name="content" placeholder="Article Content" id="postcontent" {...register('content')}></textarea>
                                        ...
                                        <div className="row">
                                            ...
                                            <div class="form-check form-switch col-6">
                                                <input class="form-check-input" onChange={(e) => {checkBox(); setBreaking(e.target.value) }} name="breaking" type="checkbox" id="postbreaking" />
